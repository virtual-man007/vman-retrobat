...
<!-- *** es_systems.cfg edited for RetroBat. Compatible with Batocera ES for Windows ***-->
<systemList>
  <system>
    <name>arcade</name>
    ...
    <emulators>
      <emulator name="angle">
        <cores>
          ...
          <core>fbalpha2012_cps1</core>
          <core>fbalpha2012_cps2</core>
          <core>fbalpha2012_cps3</core>
          <core>mame</core>
          <core>hbmame</core>
          <core>mame2016</core>
          <core>mame2015</core>
  ...
  <system>
    <name>hbmame</name>
    <fullname>Arcade - MAME Homebrew</fullname>
    <manufacturer>Arcade</manufacturer>
    <release/>
    <hardware>arcade</hardware>
  ...
  <system>
    <name>lightgun</name>
    <fullname>Arcade - Light Gun</fullname>
    <manufacturer>Arcade</manufacturer>
    <release/>
    <hardware>arcade</hardware>
    ...
    <platform>arcade</platform>
    <theme>lightgun</theme>
  </system>
  <system>
    <name>fba</name>
    <fullname>Arcade - Final Burn</fullname>
    <manufacturer>Arcade</manufacturer>
    <release/>
    <hardware>arcade</hardware>
    <path>~\..\roms\fba</path>
  ...
  <system>
    <name>daphne</name>
    <fullname>Arcade - Laserdisc</fullname>
    <manufacturer>Arcade</manufacturer>
    <release/>
    <hardware>arcade</hardware>
    <path>~\..\roms\daphne</path>
    <extension>.daphne</extension>
    <command>%HOME%\emulatorLauncher.exe %CONTROLLERSCONFIG% -system %SYSTEM% -emulator %EMULATOR% -core %CORE% -rom %ROM%</command>
    <emulators>
  ...
  <system>
    <name>gaelco</name>
    <fullname>Gaelco PowerVR</fullname>
    <manufacturer>Gaelco</manufacturer>
    <hardware>arcade</hardware>
    <path>~\..\roms\gaelco</path>
    <extension>.zip</extension>
    <command>%HOME%\emulatorLauncher.exe %CONTROLLERSCONFIG% -system %SYSTEM% -emulator %EMULATOR% -core %CORE% -rom %ROM%</command>
    <emulators>
  ...
  <system>
    <name>fds</name>
    <fullname>Nintendo Family Computer Disk System</fullname>
  ...
  <system>
    <name>snes-msu</name>
    <fullname>Super NES MSU-1</fullname>
    <manufacturer>Nintendo</manufacturer>
    <hardware>extension</hardware>
  ...
  <system>
    ...
    <hardware>console</hardware>
    <path>~\..\roms\wiiu</path>
    <extension>.iso .rpx .wud .m3u .ISO .RPX .WUD .M3U</extension>
    <command>%HOME%\emulatorLauncher.exe %CONTROLLERSCONFIG% -system %SYSTEM% -emulator %EMULATOR% -core %CORE% -rom %ROM%</command>
    <emulators>
      <emulator name="cemu"/>
    </emulators>
  ...
  <system>
    ...
    <extension>.pce .zip .7z .fba</extension>
    <command>%HOME%\emulatorLauncher.exe %CONTROLLERSCONFIG% -system %SYSTEM% -emulator %EMULATOR% -core %CORE% -rom %ROM%</command>
    <emulators>
      <emulator name="angle">
        <cores>
  ...
  <system>
    ...
    <manufacturer>3DO Company</manufacturer>
  ...
  <system>
    ...
    <extension>.zip .ZIP .adf .ADF .uae .UAE .ipf .IPF .dms .DMS .adz .ADZ .lha .LHA .rp9 .RP9</extension>
    <command>%HOME%\emulatorLauncher.exe %CONTROLLERSCONFIG% -system %SYSTEM% -emulator %EMULATOR% -core %CORE% -rom %ROM%</command>
    <emulators>
      <emulator name="angle">
        <cores>
    ...
    <theme>amiga500</theme>
    <group>amiga</group>
  </system>
  <system>
    <name>amiga1200</name>
    <fullname>Amiga AGA</fullname>
    <manufacturer>Commodore</manufacturer>
    <release>1992</release>
    <hardware>console</hardware>
    <path>~\..\roms\amiga1200</path>
    <extension>.zip .adf .uae .UAE .ipf .IPF .dms .DMS .adz .ADZ .lha .LHA .rp9 .RP9</extension>
    <command>%HOME%\emulatorLauncher.exe %CONTROLLERSCONFIG% -system %SYSTEM% -emulator %EMULATOR% -core %CORE% -rom %ROM%</command>
    <emulators>
      <emulator name="angle">
        <cores>
  ...
  <system>
    <fullname>Amiga 4000</fullname>
    <name>amiga4000</name>
    <manufacturer>Commodore</manufacturer>
    <release>1994</release>
    <hardware>computer</hardware>
    <path>~\..\roms\amiga4000</path>
    <extension>.zip .uae .lha .adf .Adf .ADF .uae .rp9 .RP9</extension>
    <command>%HOME%\emulatorLauncher.exe %CONTROLLERSCONFIG% -system %SYSTEM% -emulator %EMULATOR% -core %CORE% -rom %ROM%</command>
    <platform>amiga</platform>
  ...
  <system>
    ...
    <extension>.iso .cso .cue .zip .lha .ISO .CSO .CUE .ZIP .LHA .rp9 .RP9</extension>
    <command>%HOME%\emulatorLauncher.exe %CONTROLLERSCONFIG% -system %SYSTEM% -emulator %EMULATOR% -core %CORE% -rom %ROM%</command>
    <emulators>
      <emulator name="angle">
        <cores>
  ...
  <system>
    <name>amigacdtv</name>
    <fullname>Amiga CDTV</fullname>
    <manufacturer>Commodore</manufacturer>
    <release>1994</release>
    <hardware>console</hardware>
    <path>~\..\roms\amigacdtv</path>
    <extension>.cue .CUE .iso .ISO .cso .CSO .rp9 .RP9</extension>
    <command>%HOME%\emulatorLauncher.exe %CONTROLLERSCONFIG% -system %SYSTEM% -emulator %EMULATOR% -core %CORE% -rom %ROM%</command>
    <emulators>
      <emulator name="angle">
        <cores>
  ...
  <system>
    ...
    <extension>.nib .do .po .dsk</extension>
    <command>%HOME%\emulatorLauncher.exe %CONTROLLERSCONFIG% -system %SYSTEM% -emulator %EMULATOR% -core %CORE% -rom %ROM%</command>
  ...
  <system>
    <fullname>Spectravideo SV-318</fullname>
  ...
  <system>
    <fullname>Oric/Atmos</fullname>
    <name>oricatmos</name>
    <path>~\..\roms\oricatmos</path>
    <manufacturer>Oric</manufacturer>
    <release>1982</release>
    <hardware>computer</hardware>
    <extension>.dsk .tap</extension>
    <command>%HOME%\emulatorLauncher.exe %CONTROLLERSCONFIG% -system %SYSTEM% -emulator %EMULATOR% -rom %ROM%</command>
    <platform>oricatmos</platform>
    <theme>oric</theme>
    <emulators>
  ...
  <system>
    <name>gb2players</name>
    <fullname>Game Boy 2 Players</fullname>
    <manufacturer>Nintendo</manufacturer>
    <release>1989</release>
    <hardware>portable</hardware>
  ...
  <system>
    <name>gbc2players</name>
    <fullname>Game Boy Color 2 Players</fullname>
    <release>1998</release>
    <manufacturer>Nintendo</manufacturer>
    <hardware>portable</hardware>
  ...
  <system>
    ...
    <hardware>port</hardware>
    <path>~\..\roms\love</path>
    <extension>.zip .7z .lua .love .lutro .ZIP .LUA .LOVE .LUTRO .7Z</extension>
    <command>~\..\roms\love\%BASENAME%\love.exe "%ROM_RAW%"</command>
    <emulators>
      <emulator name="love-latest" command="%HOME%\..\emulator\love\love.exe %ROM%"/>
      <emulator name="love-specific-version" command="~\..\roms\love\%BASENAME%\love.exe %ROM%"/>
    </emulators>
  ...
  <system>
    ...
    <extension>.zip .easyrpg .ZIP .EASYRPG</extension>
    <command>%HOME%\emulatorLauncher.exe %CONTROLLERSCONFIG% -system %SYSTEM% -emulator %EMULATOR% -core %CORE% -rom %ROM%</command>
    <emulators>
      <emulator name="libretro">
        <cores>
  ...
  <system>
    ...
    <platform>tyrquake</platform>
    <theme>tyrquake</theme>
    <group>ports</group>
  </system>
  <system>
    <name>cavestory</name>
    <fullname>Cavestory</fullname>
    <manufacturer>Ports</manufacturer>
    <hardware>port</hardware>
    <release/>
    <manufacturer>Ports</manufacturer>
    <path>~\..\roms\cavestory</path>
    <extension>.libretro .exe</extension>
    <command>%HOME%\emulatorLauncher.exe %CONTROLLERSCONFIG% -system %SYSTEM% -emulator %EMULATOR% -core %CORE% -rom %ROM%</command>
    <emulators>
      <emulator name="libretro">
        <cores>
  ...
  <system>
    ...
    <emulators>
      ...
      <emulator name="openbor-specific-version" command="%ROM_RAW%"/>
    </emulators>
  ...
  <system>
    <fullname>TeknoParrot</fullname>
    <name>teknoparrot</name>
    <path>~\..\roms\teknoparrot</path>
    <manufacturer>TeknoParrot</manufacturer>
    <release/>
    <hardware>arcade</hardware>
    <extension>.teknoparrot .parrot .game</extension>
    <command>%HOME%\emulatorLauncher.exe %CONTROLLERSCONFIG% -system %SYSTEM% -emulator %EMULATOR% -rom %ROM%</command>
    <platform>arcade</platform>
    ...
    <emulators>
      ...
      <emulator name="angle">
        <cores>
          ...
          <core>dosbox_svn_ce</core>
          <core>dosbox_core</core>
        </cores>
      </emulator>
      <emulator name="libretro">
        <cores>
  ...
  <system>
    <name>Windows</name>
    <fullname>PC WINDOWS</fullname>
    <manufacturer>Microsoft</manufacturer>
    <release>1992</release>
    <hardware>computer</hardware>
    <path>~\..\roms\windows</path>
    <extension>.exe .bat .cmd .lnk .url .pc .win .windows .wine</extension>
    <command>%HOME%\emulatorLauncher.exe %CONTROLLERSCONFIG% -system %SYSTEM% -emulator %EMULATOR% -core %CORE% -rom %ROM%</command>
  ...
  <system>
    ...
    <extension>.png .p8 .PNG .P8</extension>
    <command>%HOME%\emulatorLauncher.exe %CONTROLLERSCONFIG% -system %SYSTEM% -emulator %EMULATOR% -core %CORE% -rom %ROM%</command>
    <emulators>
      <emulator name="pico8"/>
    </emulators>
  ...
  <system>
    ...
    <manufacturer>Medias</manufacturer>
    <release/>
    <path>~\..\Medias</path>
    <extension>.mkv .avi .f4v .f4f .3gp .ogm .flv .mp4 .mp3 .flac .ogg .m4a .webm .3g2 .mov .wmv .mpg .mpeg .vob .asf .divx .m2p .m2ts .ps .ts .mxf .wma .asf .MKV .AVI .F4V .F4F .3GP .OGM .FLV .MP4 .MP3 .FLAC .OGG .M4A .WEBM .3G2 .MOV .WMV .MPG .MPEG .VOB .ASF .DIVX .M2P .M2TS .PS .TS .MXF .WMA .ASF .jpg .jpeg .png  .bmp .psd .tga .gif .hdr .pic .ppm .pgm .JPG .JPEG .PNG  .BMP .PSD .TGA .GIF .HDR .PIC .PPM .PGM .pdf .PDF</extension>
    <command>%HOME%\emulatorLauncher.exe %CONTROLLERSCONFIG% -system %SYSTEM% -emulator %EMULATOR% -core %CORE% -rom %ROM%</command>
    <emulators>
      <emulator name="libretro">
        <cores>
          <core>ffmpeg</core>
          <core>imageviewer</core>
        </cores>
      </emulator>
    </emulators>
  ...
  <system>
    ...
    <command>"%ROM_RAW%" -p</command>
    <platform>ignore</platform>
    <theme>kodi</theme>
  </system>
  <system>
    <name>retrobat</name>
    <fullname>RetroBat</fullname>
    <manufacturer>RetroBat</manufacturer>
    <release/>
    <path>~\..\system\es_menu</path>
    <extension>.menu</extension>
    <command>%HOME%\..\retrobat.exe /NOF #%ROM_RAW%</command>
    <platform>ignore</platform>
    <theme>retrobat</theme>
  </system>
  <system>
