...
rem copy /Y V:\_tools\vman-retrobat-master\RetroBat\system\decorations\default_unglazed\amiga.png V:\RetroBat\decorations\default\systems\amiga.png
rem copy /Y V:\_tools\vman-retrobat-master\RetroBat\system\decorations\default_unglazed\ps2.png V:\RetroBat\decorations\default\systems\ps2.png
