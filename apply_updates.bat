...
copy /Y V:\RetroBat\system\decorations\default_unglazed\systems\amiga1200.png V:\RetroBat\decorations\default\systems\amiga.png
copy /Y V:\RetroBat\system\decorations\default_unglazed\systems\ps2.png V:\RetroBat\decorations\default\systems\ps2.png
